...
public class Product {
    ...
    @DecimalMax(value = "10.0", message = "Trọng lượng không được vượt quá 10kg")
    @Column(name = "weight", nullable = false)
    private BigDecimal weight;

    @NotNull(message = "Giá bán không được để trống")
    @Min(value = 1000000, message = "Giá bán phải từ 1.000.000đ trở lên")
    ...
    public Product(Long id, String name, String brand, String cpu, String ram, String storage, String gpu,
            String screenSize, String batteryLife, BigDecimal weight, Long price, Integer stockQuantity,
            Category category) {
        this.id = id;
        this.name = name;
        this.brand = brand;
    ...
    public String toString() {
        return "Product [id=" + id + ", name=" + name + ", brand=" + brand + ", cpu=" + cpu + ", ram=" + ram
                + ", storage=" + storage + ", gpu=" + gpu + ", screenSize=" + screenSize + ", batteryLife="
                + batteryLife + ", weight=" + weight + ", price=" + price + ", stockQuantity=" + stockQuantity
                + ", category=" + category + "]";
    }
} 